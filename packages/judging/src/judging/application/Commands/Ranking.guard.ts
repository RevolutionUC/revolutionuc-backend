...
import { Submission } from 'src/judging/domain/aggregates/category/submission.entity';
import { Project } from 'src/judging/domain/aggregates/project/project.entity';
